                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm-8 col-md-7 col-lg-9 py-4">
                            ...
                            <p className="text-muted">A test using the <a href="https://dog.ceo/dog-api/"
                                                                          target="_new">dog-api</a> library.</p>
                        </div>
                        <div className="col-sm-4 offset-md-1 col-lg-2 py-4">
                            <h4 className="text-white">Contact</h4>
                            <ul className="list-unstyled">
                                <li><a href="https://www.linkedin.com/in/andrei-zayats/" className="text-white"
                                       target="_new">linkedine</a></li>
